...
LORA_SEARCH_QUERIES = {
    ...
    # ── MOTORCYCLE CAMERA PACK (Grid Runners #64) ──
    "moto_rider_pov": {
        "label": "Motorcycle Rider POV",
        "priority": 1,
        "target_clips": 30,
        "clip_length": (3, 6),
        "min_resolution": 720,
        "queries": [
            "motorcycle rider POV handlebars",
            "sportbike onboard camera first person",
            "motorcycle cockpit view riding",
            "GoPro motorcycle chin mount POV",
            "motorcycle dashboard instruments riding",
            "sportbike rider perspective highway",
            "motorcycle night ride city POV first person",
            "motorcycle canyon road rider view",
            "superbike track onboard forward",
            "motorcycle tunnel ride POV lights",
            "Ducati Panigale onboard lap",
            "Yamaha R1 rider view track",
        ],
        "pixabay_queries": [
            "motorcycle rider view",
            "motorbike POV road",
            "sportbike riding perspective",
            "motorcycle dashboard riding",
            "biker first person road",
        ],
        "caption_template": "first person motorcycle rider POV, {details}, {speed_cue}, {atmosphere}",
        "caption_vars": {
            "details": ["handlebars and gauge cluster visible", "gloved hands on clip-ons", "instruments glowing", "windscreen visible"],
            "speed_cue": ["speed blur on periphery", "road rushing beneath", "streaking lights", "motion blur"],
            "atmosphere": ["daytime clear", "night neon city", "canyon road golden hour", "tunnel overhead lights"],
        },
        "avoid_keywords": ["crash", "accident", "stationary", "parked", "walking", "bicycle"],
    },
    "moto_low_chase": {
        "label": "Low Rear Chase Camera",
        "priority": 1,
        "target_clips": 25,
        "clip_length": (3, 5),
        "min_resolution": 720,
        "queries": [
            "motorcycle rear view tracking low angle",
            "sportbike rear tire camera riding",
            "motorcycle from behind low camera",
            "MotoGP rear wheel camera",
            "motorcycle exhaust view rear tracking",
            "bike chase scene rear camera low",
            "motorcycle following shot behind",
            "sportbike rear axle camera racing",
            "motorcycle tracking shot tail light",
            "motorcycle review rear riding shot",
        ],
        "pixabay_queries": [
            "motorcycle rear view riding",
            "motorbike from behind",
            "sportbike rear tracking",
            "motorcycle tail light road",
        ],
        "caption_template": "low angle rear tracking shot of motorcycle, {tire_detail}, {background}, {atmosphere}",
        "caption_vars": {
            "tire_detail": ["rear tire spinning in frame", "exhaust heat visible", "chain and sprocket visible"],
            "background": ["tunnel with overhead lights", "highway road", "city street"],
            "atmosphere": ["daytime", "night with neon", "dusk", "rain wet road"],
        },
        "avoid_keywords": ["crash", "parked", "stationary", "front view", "bicycle", "scooter"],
    },
    "moto_tire_closeup": {
        "label": "Tire Contact Patch Close-up",
        "priority": 1,
        "target_clips": 20,
        "clip_length": (2, 4),
        "min_resolution": 720,
        "queries": [
            "motorcycle tire close up spinning",
            "motorcycle tire slow motion",
            "sportbike tire lean angle close up",
            "motorcycle burnout tire smoke close up",
            "tire rubber asphalt contact close up",
            "MotoGP tire close up camera",
            "motorcycle tire rain water spray",
            "Pirelli motorcycle tire spinning",
            "motorcycle tire warmers removal",
            "motorcycle wheel spinning detail shot",
        ],
        "pixabay_queries": [
            "motorcycle tire close up",
            "tire spinning slow motion",
            "motorcycle wheel detail",
            "rubber tire road",
        ],
        "caption_template": "extreme close-up motorcycle tire {state}, {rubber_detail}, {surface_condition}",
        "caption_vars": {
            "state": ["spinning at speed", "leaning in corner", "burnout smoking", "rolling on wet surface"],
            "rubber_detail": ["tread pattern visible", "rubber deforming under load", "tire surface glistening"],
            "surface_condition": ["dry asphalt", "wet road with reflections", "hot track surface", "concrete"],
        },
        "avoid_keywords": ["car tire", "truck", "bicycle", "flat tire", "changing tire", "repair"],
    },
    "moto_lean_tracking": {
        "label": "Side Tracking at Lean Angle",
        "priority": 2,
        "target_clips": 25,
        "clip_length": (3, 5),
        "min_resolution": 720,
        "queries": [
            "motorcycle cornering lean angle side view",
            "MotoGP knee down side tracking",
            "sportbike lean corner trackside camera",
            "motorcycle racing side view cornering",
            "knee slider sparks motorcycle side",
            "motorcycle extreme lean angle side shot",
            "superbike corner exit side tracking",
            "motorcycle road racing cornering side",
            "track day motorcycle lean angle",
        ],
        "pixabay_queries": [
            "motorcycle cornering lean",
            "sportbike racing turn",
            "motorcycle knee down",
            "racing motorcycle side view",
        ],
        "caption_template": "side tracking shot motorcycle at extreme lean angle, {rider_detail}, {sparks_tire}, {background}",
        "caption_vars": {
            "rider_detail": ["knee down on tarmac", "full lean commitment", "elbow near ground"],
            "sparks_tire": ["sparks from knee slider", "rear tire squirming", "tire edge gripping"],
            "background": ["motion-blurred grandstands", "blurred trackside", "canyon wall blur"],
        },
        "avoid_keywords": ["crash", "upright", "straight", "parked", "bicycle"],
    },
    "moto_flyby": {
        "label": "Motorcycle Flyby",
        "priority": 2,
        "target_clips": 20,
        "clip_length": (2, 4),
        "min_resolution": 720,
        "queries": [
            "motorcycle flyby static camera",
            "sportbike passes camera at speed",
            "motorcycle drive by roadside camera",
            "MotoGP flyby pit wall",
            "motorcycle street pass camera stationary",
            "motorcycle fly past blur speed",
            "superbike race flyby spectator view",
            "drag strip motorcycle pass camera",
        ],
        "pixabay_queries": [
            "motorcycle drive by",
            "motorbike pass speed",
            "racing motorcycle flyby",
            "motorcycle road fast",
        ],
        "caption_template": "stationary camera motorcycle flyby, {speed_cue}, {aftermath}, {environment}",
        "caption_vars": {
            "speed_cue": ["motion blur streak", "screaming past at speed", "high speed pass"],
            "aftermath": ["wind and debris after pass", "dust kicked up in wake", "exhaust sound fading"],
            "environment": ["roadside", "pit wall", "urban street", "country road"],
        },
        "avoid_keywords": ["crash", "slow", "parked", "bicycle", "car"],
    },
    "moto_exhaust_detail": {
        "label": "Exhaust Flame Detail",
        "priority": 2,
        "target_clips": 20,
        "clip_length": (2, 5),
        "min_resolution": 720,
        "queries": [
            "motorcycle exhaust flame close up",
            "sportbike exhaust backfire blue flame",
            "motorcycle exhaust popping flame night",
            "Akrapovic exhaust flame motorcycle",
            "motorcycle dyno exhaust fire",
            "motorcycle exhaust glow heat",
            "SC-Project exhaust flame video",
            "Austin Racing exhaust flame sportbike",
            "motorcycle exhaust carbon fiber close up",
        ],
        "pixabay_queries": [
            "motorcycle exhaust flame",
            "exhaust pipe fire",
            "motorcycle exhaust close up",
            "motorbike exhaust smoke",
        ],
        "caption_template": "close-up motorcycle exhaust {action}, {flame_detail}, {material}, {atmosphere}",
        "caption_vars": {
            "action": ["backfire flame on deceleration", "flame burst on downshift", "glowing hot on dyno"],
            "flame_detail": ["blue flame from tip", "orange glow inside", "flame and heat shimmer"],
            "material": ["carbon fiber endcan", "titanium exhaust", "stainless steel pipe"],
            "atmosphere": ["night dark background", "dyno room", "pit garage"],
        },
        "avoid_keywords": ["car exhaust", "truck", "factory", "pollution", "smoke stack"],
    },
    "moto_wheelie_rear": {
        "label": "Wheelie from Behind",
        "priority": 3,
        "target_clips": 20,
        "clip_length": (2, 4),
        "min_resolution": 720,
        "queries": [
            "motorcycle wheelie rear view",
            "sportbike wheelie from behind",
            "motorcycle stunt wheelie rear camera",
            "supermoto wheelie low angle behind",
            "motorcycle power wheelie exit corner",
            "drag bike wheelie launch rear",
            "motorcycle wheelie smoke rear tire",
        ],
        "pixabay_queries": [
            "motorcycle wheelie",
            "motorbike stunt wheelie",
            "sportbike wheelie rear",
        ],
        "caption_template": "low angle rear shot motorcycle wheelie, {front_wheel}, {chain_detail}, {smoke}",
        "caption_vars": {
            "front_wheel": ["front wheel high in air", "front wheel lifted", "front end skyward"],
            "chain_detail": ["chain pulled taut", "drivetrain under tension", "sprocket visible"],
            "smoke": ["rear tire smoking", "tire smoke billowing", "rubber smoke drifting"],
        },
        "avoid_keywords": ["bicycle", "crash", "fall", "fail"],
    },
    "moto_garage_orbit": {
        "label": "Motorcycle Garage Orbit",
        "priority": 3,
        "target_clips": 20,
        "clip_length": (4, 8),
        "min_resolution": 720,
        "queries": [
            "motorcycle turntable showroom",
            "sportbike reveal studio orbit",
            "motorcycle product shot rotating",
            "Ducati showroom walkaround",
            "motorcycle review 360 walkaround",
            "custom motorcycle build reveal turntable",
            "BMW Motorrad reveal video studio",
            "motorcycle detail workshop lighting orbit",
            "sportbike garage beauty shot slow orbit",
        ],
        "pixabay_queries": [
            "motorcycle showroom",
            "motorbike studio display",
            "motorcycle rotating turntable",
            "sportbike detail shot",
        ],
        "caption_template": "slow orbit around {bike_type} in {environment}, {light_detail}, {surface_detail}",
        "caption_vars": {
            "bike_type": ["red sportbike", "custom motorcycle", "naked bike", "superbike"],
            "environment": ["workshop with pendant lights", "dark studio", "showroom floor", "clean garage"],
            "light_detail": ["warm light catching polished bodywork", "single key light revealing curves", "spot-lit against dark background"],
            "surface_detail": ["chrome and carbon fiber visible", "machined aluminum details", "paint reflecting light"],
        },
        "avoid_keywords": ["riding", "racing", "crash", "bicycle", "dirt bike muddy"],
    },
}
