# Migration Guide for tower-anime-production
...
- Health check: `/api/anime-production/health`
- Documentation: `/api/anime-production/docs`
- Version info: `/api/anime-production/version`
- Status: `/api/anime-production/status`

## Rollback
If issues occur, restore from backup at: `/opt/tower-anime-production/backup_pre_migration`
