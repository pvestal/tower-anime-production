#!/usr/bin/env python3
"""Simple test with Sakura reference"""
...
async def test():
    workflow = {
        ...
        "5": {"class_type": "CLIPTextEncode", "inputs": {"text": "Sakura wearing red evening dress, elegant pose", "clip": ["1", 1]}},
        ...
        "10": {"class_type": "SaveImage", "inputs": {"filename_prefix": "sakura_test", "images": ["9", 0]}}
    }
