...
CREATE INDEX IF NOT EXISTS idx_quality_scores_metric ON quality_scores(metric_name);
CREATE INDEX IF NOT EXISTS idx_quality_scores_passed ON quality_scores(passed);
CREATE INDEX IF NOT EXISTS idx_render_queue_status ON render_queue(status);
CREATE INDEX IF NOT EXISTS idx_render_queue_priority ON render_queue(priority);
CREATE INDEX IF NOT EXISTS idx_render_queue_created_at ON render_queue(created_at);