...
class WebSocketService {
  constructor() {
    ...
    // Build domain-agnostic WebSocket endpoints based on current location
    const protocol = window.location.protocol === "https:" ? "wss:" : "ws:";
    const host = window.location.host;

    this.endpoints = {
      echo: `${protocol}//${host}/api/echo/ws`,
      coordination: `${protocol}//${host}/api/coordination/ws`,
      vue_integration: `${protocol}//${host}/api/anime/ws`, // Use the anime WebSocket
    };
  }
  ...
  async connect(endpoint = "vue_integration", options = {}) {
    ...
    this.connectionPromise = new Promise((resolve, reject) => {
      try {
        const wsUrl =
          this.endpoints[endpoint] || this.endpoints.vue_integration;
