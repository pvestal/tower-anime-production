    ...
    <div class="branch-form space-y-4">
      ...
      <div class="field">
        ...
        <small class="text-gray-500"
          >Explain how this branch differs from the main storyline</small
        >
      </div>
      ...
      <div class="field">
        ...
        />
        <small class="text-gray-500"
          >The branch to create this new branch from</small
        >
      </div>
      ...
      <div class="options space-y-2">
        <div class="flex items-center gap-2">
          <Checkbox id="switch" v-model="form.switchTo" />
          <label for="switch" class="text-sm"
            >Switch to new branch immediately</label
          >
        </div>

        <div class="flex items-center gap-2">
          <Checkbox id="copy-scenes" v-model="form.copyScenes" />
          <label for="copy-scenes" class="text-sm"
            >Copy all scenes from base branch</label
          >
        </div>
      </div>
      ...
      <div
        ...
        class="preview p-3 bg-blue-50 border border-blue-200 rounded-lg"
      >
