<template>
  <div class="music-video-sync-studio">
    ...
    <div v-if="showTutorial" class="tutorial-overlay" @click="hideTutorial">
      <div class="tutorial-content" @click.stop>
        <div class="tutorial-header">
          ...
          <button class="close-btn" @click="hideTutorial">
        ...
        <div class="tutorial-actions">
          <button class="got-it-btn" @click="hideTutorial">Got it!</button>
          <label class="dont-show-again">
            <input v-model="dontShowTutorial" type="checkbox" />
            Don't show again
          </label>
        </div>
      </div>
    ...
    <div class="help-float">
      <button class="help-btn" title="Help & Tips" @click="showHelp">
    ...
    <div v-if="showHelpPanel" class="help-panel">
      <div class="help-header">
        ...
        <button class="close-help-btn" @click="showHelpPanel = false">
          <i class="pi pi-times"></i>
        </button>
      </div>
      ...
      <div class="help-content">
        ...
        <div v-if="currentModeData.shortcuts" class="keyboard-shortcuts">
...
const allModes = [
  {
    ...
    icon: "✨",
    helpText:
      "Smart Sync automatically analyzes your video and creates perfect music synchronization with minimal input. Just choose your scene type, drop your files, and let AI do the rest.",
    tips: [
  ...
  },
  {
    ...
    icon: "⚙️",
    helpText:
      "Quick Controls provides essential timing and style controls with a visual timeline. Perfect for users who want some control over the sync process without overwhelming complexity.",
    tips: [
  ...
  },
  {
    ...
    icon: "🎛️",
    helpText:
      "Professional mode provides complete control over all aspects of music-video synchronization. Access advanced audio analysis, manual beat editing, and batch processing capabilities.",
    tips: [
