  ...
  <div class="generation-mode-selector">
    ...
    <div class="mode-cards">
      ...
      >
        ...
        <div v-if="selectedMode === mode.id" class="selected-indicator">✓</div>
      </div>
    </div>
    ...
    <transition name="slide">
      <div v-if="showAdvanced" class="advanced-settings">
        ...
        <div class="setting-group">
          <label>Sampler</label>
          <select
            v-model="customSettings.sampler"
...
const estimatedQuality = computed(() => {
  ...
  const samplerScore = ["euler", "dpm_fast"].includes(
    customSettings.value.sampler,
  )
    ? 70
    : 90;
