  ...
  <div class="intent-classification-wizard">
        ...
        <div class="progress-steps">
          ...
          >
            <div class="step-circle">
              <i
                v-if="currentStepIndex < index || currentStepIndex === index"
                :class="step.icon"
              ></i>
    ...
    <div v-if="currentStep === 'input'" class="wizard-step">
      <div class="input-section">
        <!-- Quick templates -->
        <div v-if="quickTemplates.length > 0" class="quick-templates mb-6">
          ...
          <div class="templates-grid">
            ...
            >
              <div class="template-icon">
                <i
                  :class="getTemplateIcon(template.classification.content_type)"
                ></i>
              </div>
              <div class="template-content">
                ...
                <div class="template-stats">
                  <span class="usage-count"
                    >{{ template.usage_count }} uses</span
                  >
        ...
        <div class="custom-input">
          ...
          <div class="generation-type-selector mb-4">
            ...
            <div class="type-buttons">
              <button
                :class="[
                  'type-btn',
                  { active: explicitGenerationType === 'image' },
                ]"
              ...
              <button
                :class="[
                  'type-btn',
                  { active: explicitGenerationType === 'video' },
                ]"
          ...
          <div class="input-container">
            ...
            <div v-if="inputHints.length > 0" class="input-hints">
              <div
            ...
            <div class="options-grid">
              <div class="option-group">
                ...
                <select v-model="preferredStyle" class="option-select">
                  ...
                  <option value="photorealistic_anime">
          ...
          <div class="input-actions">
            ...
            <button
              :disabled="
                !userPrompt.trim() || !explicitGenerationType || isProcessing
              "
              class="btn-primary"
              @click="classifyIntent"
            >
              <i v-if="!isProcessing" class="fas fa-magic"></i>
      ...
      <div class="processing-section">
        <div class="processing-animation">
          ...
          <div class="processing-steps">
            ...
            >
              <i v-if="step.status !== 'completed'" :class="step.icon"></i>
              <i v-else class="fas fa-check"></i>
    ...
    <div v-if="currentStep === 'clarification'" class="wizard-step">
      <div class="clarification-section">
        ...
        <div class="clarification-questions">
          ...
          >
            <h4 class="question-title">
              ...
              >
              <span
                v-else-if="question.priority === 'medium'"
            ...
            >
              ...
              >
                <i
                  v-if="clarificationAnswers[question.id] === option"
        ...
        <div class="clarification-actions">
          <button class="btn-secondary" @click="skipClarification">
      ...
      <div class="review-section">
        <div class="classification-result">
            ...
            <div class="confidence-indicator">
              ...
              <div class="confidence-bar">
                <div
                  ...
                  :style="{
                    width:
                      (classificationResult?.confidence_score || 0) * 100 + '%',
                  }"
                ></div>
              </div>
          ...
          <div class="result-details">
            <div class="detail-grid">
              <div class="detail-item">
                ...
                <div class="detail-value">
                  <i
                    :class="
                      getContentTypeIcon(classificationResult?.content_type)
                    "
                  ></i>
              ...
              <div
                v-if="classificationResult?.duration_seconds"
                class="detail-item"
              >
            ...
            <div
              v-if="classificationResult?.character_names?.length > 0"
              class="characters-section"
            >
              <label>Characters</label>
              <div class="character-tags">
                <span
                  v-for="character in classificationResult.character_names"
                  :key="character"
                  class="character-tag"
                >
                  {{ character }}
          ...
          <div class="technical-details">
            ...
            <div class="tech-grid">
              <div class="tech-item">
                ...
                <span>{{
                  formatValue(classificationResult?.target_service)
                }}</span>
              </div>
              <div class="tech-item">
                ...
                <span
                  >{{
                    classificationResult?.estimated_time_minutes || "N/A"
                  }}
                  minutes</span
                >
              </div>
              <div class="tech-item">
                ...
                <span
                  >{{
                    classificationResult?.estimated_vram_gb || "N/A"
                  }}
                  GB</span
                >
              </div>
              <div class="tech-item">
                ...
                <span>{{
                  formatValue(classificationResult?.output_format)
                }}</span>
              </div>
            </div>
          </div>
          ...
          <!-- Ambiguity warnings -->
          <div
            v-if="classificationResult?.ambiguity_flags?.length > 0"
            class="ambiguity-warnings"
          >
            ...
            <div class="warning-list">
              <div
                v-for="flag in classificationResult.ambiguity_flags"
                :key="flag"
                class="warning-item"
              >
        ...
        <div class="review-actions">
          ...
          <button class="btn-primary" @click="startGeneration">
      ...
      <div class="results-section">
        <div v-if="generationStatus === 'success'" class="success-message">
          ...
          <p class="text-gray-300">
            Your request has been routed to the appropriate generation service.
          </p>
        </div>
...
export default {
  ...
  setup() {
    ...
    const hasRequiredClarifications = computed(() => {
      const requiredQuestions = clarificationQuestions.value.filter(
        (q) => q.priority === "high",
      );
...
• Magical transformation sequence lasting 10 seconds`;
    ...
    const handlePromptChange = () => {
      ...
      if (userPrompt.value.trim()) {
        if (
          !/\b(character|person|girl|boy|man|woman)\b/i.test(userPrompt.value)
        ) {
          inputHints.value.push({
            type: "suggestion",
        ...
        if (
          !/\b(anime|realistic|cartoon|artistic)\b/i.test(userPrompt.value) &&
        ...
        if (
          explicitGenerationType.value === "video" &&
          !/\d+\s*(second|minute)/i.test(userPrompt.value)
        ) {
          inputHints.value.push({
            type: "suggestion",
            icon: "fas fa-clock",
            message:
              'For videos, specify duration (e.g., "5 seconds", "30 seconds")',
          });
        }
      }
    };
        ...
        if (response.ok) {
          ...
          if (classificationResult.value.suggested_clarifications?.length > 0) {
            clarificationQuestions.value =
              classificationResult.value.suggested_clarifications;
        ...
        if (response.ok) {
          ...
          if (routingResult.success) {
            ...
            generationError.value =
              ...
              routingResult.prerequisites_missing.join(", ");
          }
        } else {
