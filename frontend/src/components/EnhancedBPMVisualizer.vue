  ...
  <div class="enhanced-bpm-visualizer">
    ...
    <div class="bpm-header">
      ...
      <div class="tempo-classification">
        ...
        <div v-if="detectedKey" class="key-signature">
          Key: {{ detectedKey }}
        </div>
      </div>
      ...
      <div class="analysis-controls">
        ...
        <button class="calibrate-btn" @click="calibrateBPM">
    ...
    <div ref="waveformContainer" class="waveform-container">
      ...
      <div class="waveform-overlay">
        ...
        >
          ...
          <div v-if="beat.label" class="marker-label">{{ beat.label }}</div>
        </div>
    ...
    <div class="beat-grid-container">
      <div class="beat-grid">
        <div v-for="(bar, index) in beatGrid" :key="index" class="beat-bar">
          <div
            v-for="(beat, beatIndex) in bar.beats"
            :key="beatIndex"
            class="beat-cell"
            :class="{
    ...
    <!-- BPM Analysis Stats -->
    <div v-if="analysisData" class="analysis-stats">
      ...
      <div class="stat-group">
        <div class="stat-item">
          ...
          <span class="energy-meter">
            <div
              class="energy-bar"
              :style="{ width: analysisData.energy + '%' }"
            ></div>
    ...
    <!-- Manual BPM Input -->
    <div v-if="showManualControls" class="manual-controls">
      <div class="manual-input-group">
        ...
        />
        <button class="apply-btn" @click="applyManualBPM">Apply</button>
      </div>
      ...
      <div class="tap-tempo">
        ...
        <div v-if="tapCount > 0" class="tap-count">
