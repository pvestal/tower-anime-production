    ...
    <div class="studio-layout">
      ...
      <div class="character-list-panel">
        <div class="panel-header">
          <h3>Characters</h3>
          <button class="btn-create-character" @click="showCreateDialog = true">
        ...
        <div class="character-list">
          ...
          >
            ...
            <div class="character-actions">
              ...
              <button class="btn-edit" @click.stop="editCharacter(character)">
      ...
      <div v-if="selectedCharacter" class="generation-panel">
      ...
      <div class="results-grid">
        ...
        >
          <img
            ...
            :alt="`${result.character_name} generation`"
          />
    ...
    async generateCharacterImage(character) {
      ...
      try {
        const response = await fetch(
          `/api/anime/characters/${character.id}/generate`,
          {
            method: "POST",
            headers: {
        ...
        if (response.ok) {
          ...
          this.$toast.success(
            `Generation started for ${character.character_name}`,
          );
