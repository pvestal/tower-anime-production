  ...
  <div class="cp-character-panel cp-fade-in">
    ...
    <div class="parameter-grid">
      ...
      <div class="parameter-group">
        ...
        <div class="color-palette-grid">
          <div
            ...
            :class="[
              'color-swatch',
              { active: parameters.colorPalette === palette.name },
            ]"
      ...
      <div class="parameter-group advanced-settings">
        <label>
          <input v-model="parameters.enableGlow" type="checkbox" />
          Enable Neon Glow Effects
        </label>
        <label>
          <input v-model="parameters.enableParticles" type="checkbox" />
          Add Atmospheric Particles
        </label>
        <label>
          <input v-model="parameters.enableMotionBlur" type="checkbox" />
          Enable Motion Blur
        </label>
      </div>
    ...
    <div v-if="generatedCharacter" class="character-preview">
      ...
      <div class="preview-actions">
        ...
        <button class="cp-button" @click="saveCharacter">
          Save to Library
        </button>
        <button class="cp-button" @click="regenerateVariation">
          Generate Variation
        </button>
      </div>
    </div>
...
function buildCharacterPrompt() {
  ...
  if (parameters.value.psychIntensity > 60) {
    prompt +=
      ", psychological thriller atmosphere, intense gaze, dark undertones";
  }
...
function randomizeParameters() {
  ...
  parameters.value.colorPalette =
    colorPalettes[Math.floor(Math.random() * colorPalettes.length)].name;
}
