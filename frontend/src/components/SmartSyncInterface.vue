    ...
    <div class="smart-sync-content">
      ...
      <div class="drop-zone-container">
        <div class="drop-zones">
          ...
          <div
            ...
            :class="{
              'drag-over': isDragOverMusic,
              'has-file': selectedMusic,
              'auto-selected': autoSelectedMusic,
            }"
          ...
          >
            ...
            />
            <div
              v-if="!selectedMusic && !autoSelectedMusic"
              class="drop-content"
            >
            ...
            <div v-else-if="autoSelectedMusic" class="auto-selection">
              ...
              <div class="auto-text">
                ...
                <div class="auto-subtitle">
                  based on your {{ selectedTemplate?.name || "scene" }}
                </div>
              </div>
              <button class="browse-btn" @click.stop="triggerMusicUpload">
            ...
            <div v-else class="file-preview">
              <div class="audio-preview">
                ...
                <button class="play-btn" @click.stop="playMusic">
              ...
              <div class="file-info">
                ...
                <div class="file-details">
                  ...
                  {{ formatFileSize(selectedMusic.size) }}
                </div>
              </div>
              <button class="remove-btn" @click.stop="removeMusic">
                <i class="pi pi-times"></i>
              </button>
            </div>
          </div>
      ...
      <div class="sync-action">
        ...
        <div v-if="canSync && !isSyncing" class="sync-description">
          AI will analyze your {{ selectedTemplate?.name || "video" }} and
          create perfect sync
        </div>
      </div>
      ...
      <div v-if="syncResult" class="sync-result">
        <div class="result-header">
          ...
          <div class="result-stats">
            ...
            <span class="stat"
              >{{ formatDuration(syncResult.duration) }} duration</span
            >
          </div>
        </div>
        ...
        <div class="result-actions">
          <button class="export-btn primary" @click="exportToJellyfin">
            <i class="pi pi-download"></i> Export to Jellyfin
          </button>
          <button class="try-different-btn" @click="tryDifferentMusic">
            <i class="pi pi-refresh"></i> Try Different Music
          </button>
          <button class="advanced-btn" @click="showAdvancedControls">
      ...
      <div v-if="!selectedVideo && !selectedMusic" class="help-section">
        ...
        <div class="tips-card">
          ...
          <ul>
            <li>
              <strong>Action scenes:</strong> Work best with high-energy music
            </li>
            <li>
              <strong>Emotional scenes:</strong> Slower music syncs to dialogue
            </li>
            <li>
              <strong>Custom music:</strong> Upload your own for unique results
            </li>
            <li>
              <strong>Need control?</strong> Switch to Quick Controls mode
            </li>
          </ul>
        </div>
      </div>
...
const canSync = computed(() => {
  return (
    selectedVideo.value &&
    (selectedMusic.value || autoSelectedMusic.value) &&
...
const smartSyncButtonText = computed(() => {
  ...
  if (!selectedMusic.value && !autoSelectedMusic.value)
    return "Add music or let AI choose";
