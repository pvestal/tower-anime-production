...
TYPE_RULES = [
    (r'^test_', "test"),
    (r'civitai_goblins', "character"),
    (r'civitai_gs_', "character"),
    (r'civitai_dark_fantasy', "style"),
    (r'civitai_neon_cyberpunk', "style"),
    (r'anthro_wolf', "character"),
    (r'sheep_anthro', "character"),
    (r'^goblin_slayer', "character"),
    (r'^cyber_goblin', "character"),
    (r'^street_goblin', "character"),
    (r'^corporate_executive', "character"),
    (r'^elena_reyes', "character"),
    (r'^jamal', "character"),
    (r'^marcus_thompson', "character"),
    (r'^victim_', "character"),
    (r'^zara_hosseini', "character"),
    (r'^takeshi_sato', "character"),
    (r'^yuki_tanaka', "character"),
    (r'^mei_', "character"),
    (r'^rina_', "character"),
