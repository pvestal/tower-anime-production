...
async def orchestrate_production(request: dict):
    ...
    try:
        from services.generation.simple_generator import generate_with_tracking
...
from api.websocket_endpoints import add_websocket_endpoints, start_background_tasks
